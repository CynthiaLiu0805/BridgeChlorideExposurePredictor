...
\textbf{Name} & \textbf{In} & \textbf{Out} & \textbf{Exceptions} \\
\hline
draw &  [cl: $\mathbb{R}$] & graphs drew by the built in library& - \\
\hline
\end{tabular}
\end{center}
...
\subsubsection{State Variables}
long, lat: a pair of input of  [long: $\mathbb{R}$, lat: $\mathbb{R}$] \# input coordinate\\
...
\item output: graphs drew by the built in library
