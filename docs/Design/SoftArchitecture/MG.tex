...
\item[\refstepcounter{acnum} \actheacnum \label{acInputMethod}:] Allow user to click a point on the map as another way of inputing coordinate.
...
\begin{description}
\item[Secrets:] The kind of valid and invalid data. The software and physical constraint
...
\midrule
R1 & \mref{mInput}, \mref{mInputVerification}, \mref{mControl}\\
