...
class TestCalculation(unittest.TestCase):
    def setUp(self):
        self.df = pd.read_excel("data.xlsx", sheet_name='Sheet1', usecols='A,B,D,E', skiprows=0, nrows=1645)
        self.t1 = pd.read_excel("data.xlsx", sheet_name='t1', usecols='B:BD', skiprows=0, nrows=1645)
        self.h_total = pd.read_excel("data.xlsx", sheet_name='htotal', usecols='B:BD', skiprows=0, nrows=1645)
        self.t2 = pd.read_excel("data.xlsx", sheet_name='t2', usecols='B:BD', skiprows=0, nrows=1645)
