...
Constant: 
        ldv_ratio: ratio of chloride ions sprayed and splashed by trucks to light duty vehicles
'''
import numpy as np
...
def calculate(SD_totalCl, t2, AADT, AADTT):
    ...
    C_s_air = (SD_totalCl / Constant.ldv_ratio * (AADT-AADTT) + SD_totalCl * AADTT) * t2
    return C_s_air
