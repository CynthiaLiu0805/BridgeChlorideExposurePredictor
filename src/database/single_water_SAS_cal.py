...
def calculate(h_app):
    ...
    MR_BW = 0.5 * V_speed * Constant.b * (h_app-(Constant.K*Constant.h_film) -
                                          ((1-Constant.K) * h_app)) * Constant.water_density
    MR_SW = 0.5 * V_speed * Constant.b * (h_app-(Constant.K*Constant.h_film) -
                                          ((1-Constant.K) * h_app)) * Constant.water_density
